...
\begin{itemize}
	\item \textbf{Presentation Layer}
	      \begin{itemize}
		      ...
		      \item \textbf{Componenti:}
		            \begin{itemize}
			            \item \textbf{View:} Mostra le informazioni all'utente
			            \item \textbf{Controller:} Riceve l'input dell'utente (es. click del mouse, dati da un form) e decide cosa fare, comunicando con il layer sottostante.
		            \end{itemize}
	      \end{itemize}
	...
	\item \textbf{Business Logic Layer}
	      \begin{itemize}
		      ...
		      \item \textbf{Componenti:}
		            \begin{itemize}
			            \item \textbf{BusinessLogic / Service / Strategy:} Questi componenti implementano le funzionalità principali (es. Calcola produzione media, verifica validità dei dati, genera report). Ricevono richieste dal Presentation Layer e le elaborano.
		            \end{itemize}
	      \end{itemize}
	...
	\item \textbf{Data Access Layer}
	      \begin{itemize}
		      ...
		      \item \textbf{Componenti:}
		            \begin{itemize}
			            \item \textbf{Database:} Il luogo dove i dati sono fisicamente memorizzati.
			            \item \textbf{ORM (Object-Relational Mapping):} Uno strumento che aiuta a "tradurre" gli oggetti usati nell'applicazione in tabelle del database, e viceversa.
			            \item \textbf{JDBC (Java Database Connectivity):} Una tecnologia specifica per connettersi ed eseguire comandi sul database.
		            \end{itemize}
	      \end{itemize}
	...
	\item \textbf{Domain Layer}
	      \begin{itemize}
		      ...
		      \item \textbf{Componenti:}
		            \begin{itemize}
			            \item \textbf{DomainModel:} Rappresenta le entità chiave del sistema con i loro attributi e relazioni.
		            \end{itemize}
	      \end{itemize}
\end{itemize}
